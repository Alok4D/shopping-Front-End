...
//               </button>
//               <div className="absolute right-0 hidden w-20 mt-1 bg-white rounded shadow-lg group-hover:block z-10">
...
//             <ul className="flex  lg:space-x-4 xl:space-x-6 2xl:space-x-8 font-medium text-gray-700">
...
//             <div className="flex items-center space-x-1 gap- text-md">
//               <FiPhone />
...
//             <ul className="flex justify-center items-center flex-col mb-4 space-y-2 font-medium text-gray-700">
//               {navItems.map((item, index) => (
//                 <li key={index}>
//                   <NavLink
//                     to={item.path}
//                     className={({ isActive }) =>
//                       `block py-1 hover:text-green-700 ${isActive ? "text-green-700 font-semibold" : ""}`
//                     }
//                   >
//                     {item.name}
//                   </NavLink>
...
//             {/* Mobile Icons */}
//             <div className="flex justify-center items-center  flex-wrap gap-4 text-xl text-gray-700">
//               <div className="flex items-center space-x-1 text-md" >
//                 <FiPhone />
//                 <span className="cursor-pointer text-base hidden lg:block ">(219) 555-0114</span>
//               </div>
//               <FiSearch className="cursor-pointer hover:text-green-700" />
//               <FiHeart className="cursor-pointer hover:text-green-700" />
          ...
          <div className="px-4 pb-4 mt-4 lg:hidden">
            <ul className="flex justify-center items-center flex-col mb-4 space-y-2 font-medium text-gray-700">
              {navItems.map((item, index) => (
                <li
                  key={index}
                  className="menu-item opacity-0 transition-all duration-300"
                  style={{
