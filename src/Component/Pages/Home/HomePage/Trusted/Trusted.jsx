...
import Man1 from "../../../../../assets/sabbirassets/TopCategories/Man.png";
import Man2 from "../../../../../assets/sabbirassets/TopCategories/Man1.png";
import { Link } from "react-router-dom";

const Trusted = () => {
  return (
    <section className="bg-white py-16">
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-10 px-4 md:px-6 lg:px-10">
        {/* Left Images */}
